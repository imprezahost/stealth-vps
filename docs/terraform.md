...
module "stealth_vps_bootstrap" {
  source = "github.com/imprezahost/stealth-vps//terraform/modules/stealth-vps?ref=v0.5.9"

  stealth_version = "v0.5.9"
...
- The example tree is **Hetzner + AWS + DigitalOcean + Vultr + Proxmox** as of v0.5.9. Pulumi reference lands next; the module itself works against any provider whose Terraform resource accepts a string user_data.
