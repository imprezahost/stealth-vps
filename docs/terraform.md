...
- The example tree is **Hetzner + AWS + DigitalOcean + Vultr + Proxmox** as of v0.10.0. Pulumi reference lands next; the module itself works against any provider whose Terraform resource accepts a string user_data.
