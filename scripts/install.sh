...
#
# Usage:
#   curl -sSL https://raw.githubusercontent.com/imprezahost/stealth-vps/v0.6.3/scripts/install.sh | bash
#
# Env vars honored by both modes (TUI uses them as defaults):
#   STEALTH_VERSION              release tag to deploy (default: v0.6.3)
...
# ===========================================================================
STEALTH_VERSION="${STEALTH_VERSION:-v0.6.3}"
