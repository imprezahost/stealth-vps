...
```bash
curl -sSL https://raw.githubusercontent.com/imprezahost/stealth-vps/v0.6.4/scripts/install.sh | bash
```
...
```bash
curl -sSL https://raw.githubusercontent.com/imprezahost/stealth-vps/v0.6.4/scripts/install.sh \
  | STEALTH_VERSION=v0.6.4 bash
```
