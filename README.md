...
```bash
curl -fsSL https://raw.githubusercontent.com/imprezahost/stealth-vps/v0.8.1/scripts/install.sh -o install.sh
...
```bash
curl -sSL https://raw.githubusercontent.com/imprezahost/stealth-vps/v0.8.1/scripts/install.sh | sudo bash
```
...
module "stealth_vps_bootstrap" {
  source = "github.com/imprezahost/stealth-vps//terraform/modules/stealth-vps?ref=v0.8.1"

  stealth_version   = "v0.8.1"
