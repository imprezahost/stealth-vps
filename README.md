...
| **v0.5.5** | **DigitalOcean Terraform example** — third worked example; `digitalocean_droplet` + `digitalocean_firewall` + `digitalocean_ssh_key`; amd64-only on DO; documents the 1 TB included transfer vs AWS ~$90/TB egress | **shipped 2026-05-14** |
| v0.5.x | Vultr / Proxmox Terraform examples, Pulumi reference | planned |
