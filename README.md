...
```bash
curl -fsSL https://raw.githubusercontent.com/imprezahost/stealth-vps/v0.11.0/scripts/install.sh -o install.sh
...
```bash
curl -sSL https://raw.githubusercontent.com/imprezahost/stealth-vps/v0.11.0/scripts/install.sh | sudo bash
```
